  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
      <div className="p-6 bg-white shadow-sm rounded-lg border">
        ...
        <p className="text-sm text-muted-foreground mb-4">Create a campaign first to upload leads</p>
        <div className="flex flex-col space-y-4">
          ...
          <input 
            ...
            disabled={true}
          />
          <p className="text-xs text-muted-foreground">Use "+ New Campaign" button above to create a campaign first</p>
        </div>
      </div>
      ...
      <div className="p-6 bg-white shadow-sm rounded-lg border">
        ...
        <div className="flex flex-col space-y-4">
          ...
          <p className="text-xs text-muted-foreground">Create a campaign and upload leads to begin calling</p>
        </div>
      </div>
    </div>
  );
